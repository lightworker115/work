...
<div class="container">
    <div class="main col-md-12 col-xs-12">
        <form style="margin-left: 250px;" class="bs-example bs-example-form" role="form" action="<?=Url::toRoute('up')?>" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="请输入店铺名称" name="name" value="<?=$data->name?>">
            </div>

            <div class="input-group" style="margin-top: 57px;">
                <span class="input-group-addon" >* logo:</span>
                <?php echo FileUpload::widget(["config" => [ 'serverUrl' => Url::to(['uploads','action'=>'uploadimage'])],'value'=>$data->logo]); ?>
            </div>
...
<!--            </div>-->
            ...
            <div  style=" position: relative;top: 40px;left: 121px;">
