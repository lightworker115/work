...
<!--                <input type="text" class="form-control" placeholder="请输入openid" name="openid" value="--><!--">-->
<!--            </div>-->

            <div class="input-group">
                <span class="input-group-addon"  >* 图片:</span>
                <?=QiniuFileInput::widget(['name'=>'img','value'=>$data->img,
                    'qlConfig'=>[
                        "accessKey" => $accessKey,
                        "secretKey" => $secretKey,
                        "bucket" => $bucket,
            ...
            <div class="input-group">
                <div style="width: 800px;height:374px; ">
                    ...
                    <div style="margin-left: 110px;margin-top: 27px">
                        <textarea name="describe" id="" cols="100" rows="10"><?=$data->describe?></textarea>
                    </div>
                </div>
            </div>
            <!--状态选择-->
            <div class="layui-form-item" style="margin-top: -38px;margin-left: 61px;position: relative">
                <div class="layui-input-block">
                    ...
                    <select name="status" lay-verify="required" style="position: absolute;top: 0;left: 46px;">
                        <option value="1" <?php if ($data->status == 1):?> selected <?php endif;?>>通过</option>
                        <option value="2" <?php if ($data->status == 2):?> selected <?php endif;?>>未通过</option>
                    </select>
                </div>
            </div>
            <input type="hidden" name="old" value="1">  <!-- 充当场景值-->
