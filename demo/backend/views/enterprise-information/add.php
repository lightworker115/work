...
<!--            <div><input type="text" id="url"> <button class="btn btn-default" id="clickme" type="button">点我获取</button></div>-->
            <div class="input-group">
    ...
    <div>
        ...
        <script>
            $("#clickme").click(function () {
                var url = $('#url').val();
                $.ajax({
                    url:"http://"+document.domain+'/'+'enterprise-information'+'/'+'gethtml',
                    data:{'url':url},
                    success:function(e){
                        var ue = UE.getEditor('w0');
                        ue.execCommand('inserthtml',e);
                    }
                })
            });
