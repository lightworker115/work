    ...
    <div class="main col-md-12 col-xs-12">
        <form class="bs-example bs-example-form" role="form" action="<?=Url::toRoute('addinfo')?>" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <input type="hidden" class="form-control" placeholder="企业id" name="enterprise_id" value="<?=$data->enterprise_id ?>">
            </div>

            <div class="input-group">
                <span class="input-group-addon">* 职位:</span>
                <input type="text" class="form-control" placeholder="请输入职位" name="position" value="<?=$data->position ?>">
            </div>

            <div class="input-group">
                <span class="input-group-addon" >* 招聘人数:</span>
                <input type="number" class="form-control" placeholder="请输入招聘人数" name="num" value="<?=$data->num ?>" min="0">
            </div>

            <div class="input-group">
                <span class="input-group-addon">* 专业:</span>
                <input type="text" class="form-control" placeholder="请输入专业" name="major" value="<?=$data->major ?>">
            </div>

            <div class="input-group">
                <span class="input-group-addon">* 学历:</span>
                <input type="text" class="form-control" placeholder="请输入学历" name="education" value="<?=$data->education ?>">
            </div>

            <div class="input-group">
                <span class="input-group-addon">* HR电话:</span>
                <input type="text" class="form-control" placeholder="请输入电话" name="phone" value="<?=$data->phone?>">
            </div>

            <div class="input-group" style="margin-top: 10px">
                <span class="input-group-addon">* 排序:</span>
                <input type="text" class="form-control" placeholder="" name="sort" value="<?=$data->sort ?>">
            </div>
            ...
            <div class="layui-form-item" style="margin-top: -38px;margin-left: 61px;position: relative">
                <div class="layui-input-block">
                    ...
                    <select name="status" lay-verify="required" style="position: absolute;top: 0;left: 46px;">
                        ...
                        <option value="2" <?php if ($data->status == 2):?> selected <?php endif;?>>未启用</option>
                    </select>
                </div>
            </div>
            <!--        替代场景值-->
