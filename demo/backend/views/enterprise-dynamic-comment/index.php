...
<?php $this->beginBlock('javascript') ?>
    <script type="text/javascript">
        var nickNmae = <?=Json::encode($nickname)?>;
        var img = <?=Json::encode($img)?>;
        var m = meTables({
            title: "动态评论",
            param:{
                id: 2
...
//                    {"title": "openid", "data": "openid", "edit": {"type": "hidden", "required": true}, "bSortable": false,"bShow":false},
                    {"title": "用户名", "data": "openid", "bViews":false,"value":nickNmae, "bSortable": false,"createdCell": function (td,data) {
                        $(td).html(nickNmae[data]);
                    }},
                    {"title": "用户头像", "data": "openid", "value":nickNmae, "bSortable": false,"createdCell": function (td,data) {
                        $(td).html('<img src="'+img[data]+'" style="height:39px;width:39px;border:1px solid #e8e8e8;">');
                    }},
